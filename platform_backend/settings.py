...
Generated by 'django-admin startproject'; maintained for Django 5.2 / Python 3.12.
...
MIDDLEWARE = [
    ...
    'core.operations.middleware.MaintenanceModeMiddleware',
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': int(os.getenv('ACCOUNT_PASSWORD_MIN_LENGTH', '8')),
        },
    },
    {
...
ACCOUNT_REGISTRATION_V2_ENABLED = os.getenv(
...
ACCOUNT_REGISTRATION_MAX_REQUEST_BYTES = int(os.getenv(
    'ACCOUNT_REGISTRATION_MAX_REQUEST_BYTES', str(16 * 1024),
))

ACCOUNT_RATE_LIMIT_ENABLED = os.getenv('ACCOUNT_RATE_LIMIT_ENABLED', 'false').lower() == 'true'
RATE_LIMIT_REDIS_URL = os.getenv('RATE_LIMIT_REDIS_URL', '')
ACCOUNT_RATE_LIMIT_PREFIX = os.getenv('ACCOUNT_RATE_LIMIT_PREFIX', 'account:rate')
REGISTRATION_REQUEST_WINDOW_SECONDS = int(os.getenv('REGISTRATION_REQUEST_WINDOW_SECONDS', '600'))
REGISTRATION_GLOBAL_REQUEST_LIMIT = int(os.getenv('REGISTRATION_GLOBAL_REQUEST_LIMIT', '500'))
REGISTRATION_IP_REQUEST_LIMIT = int(os.getenv('REGISTRATION_IP_REQUEST_LIMIT', '20'))
REGISTRATION_IP_ACCOUNT_LIMIT = int(os.getenv('REGISTRATION_IP_ACCOUNT_LIMIT', '3'))
REGISTRATION_EMAIL_REQUEST_LIMIT = int(os.getenv('REGISTRATION_EMAIL_REQUEST_LIMIT', '5'))
LOGIN_FAILURE_WINDOW_SECONDS = int(os.getenv('LOGIN_FAILURE_WINDOW_SECONDS', '600'))
LOGIN_IDENTIFIER_FAILURE_LIMIT = int(os.getenv('LOGIN_IDENTIFIER_FAILURE_LIMIT', '10'))
LOGIN_IP_FAILURE_LIMIT = int(os.getenv('LOGIN_IP_FAILURE_LIMIT', '50'))
...
PASSWORD_RESET_RESEND_INTERVAL_SECONDS = int(
    os.getenv('PASSWORD_RESET_RESEND_INTERVAL_SECONDS', '60')
)
PASSWORD_RESET_DAILY_SEND_LIMIT = int(os.getenv('PASSWORD_RESET_DAILY_SEND_LIMIT', '10'))
PASSWORD_RESET_IP_LIMIT = int(os.getenv('PASSWORD_RESET_IP_LIMIT', '20'))
EMAIL_CHANGE_TOKEN_TTL_HOURS = int(os.getenv('EMAIL_CHANGE_TOKEN_TTL_HOURS', '24'))
EMAIL_CHANGE_RESEND_INTERVAL_SECONDS = int(
    os.getenv('EMAIL_CHANGE_RESEND_INTERVAL_SECONDS', '60')
)
EMAIL_CHANGE_DAILY_SEND_LIMIT = int(os.getenv('EMAIL_CHANGE_DAILY_SEND_LIMIT', '10'))
EMAIL_CHANGE_IP_LIMIT = int(os.getenv('EMAIL_CHANGE_IP_LIMIT', '20'))
ACCOUNT_SECURITY_CHANGE_WINDOW_SECONDS = int(
    os.getenv('ACCOUNT_SECURITY_CHANGE_WINDOW_SECONDS', '600')
)
ACCOUNT_SECURITY_CHANGE_USER_LIMIT = int(os.getenv('ACCOUNT_SECURITY_CHANGE_USER_LIMIT', '10'))
ACCOUNT_SECURITY_CHANGE_IP_LIMIT = int(os.getenv('ACCOUNT_SECURITY_CHANGE_IP_LIMIT', '30'))
ACCOUNT_LEGAL_VERSION = os.getenv('ACCOUNT_LEGAL_VERSION', '2026-09-16')
LEGAL_OPERATOR_NAME = os.getenv('LEGAL_OPERATOR_NAME', '待配置的平台运营主体')
LEGAL_CONTACT_EMAIL = os.getenv('LEGAL_CONTACT_EMAIL', '待配置')
LEGAL_CONTACT_ADDRESS = os.getenv('LEGAL_CONTACT_ADDRESS', '待配置')
ACCOUNT_SECURITY_EVENT_RETENTION_DAYS = int(
    os.getenv('ACCOUNT_SECURITY_EVENT_RETENTION_DAYS', '180')
)
ACCOUNT_SECURITY_ALERT_FAILURE_THRESHOLD = int(
    os.getenv('ACCOUNT_SECURITY_ALERT_FAILURE_THRESHOLD', '50')
)
ACCOUNT_SECURITY_ALERT_MAIL_THRESHOLD = int(
    os.getenv('ACCOUNT_SECURITY_ALERT_MAIL_THRESHOLD', '5')
)
...
# 生产 Cookie/HTTPS 安全基线。反向代理必须正确设置 X-Forwarded-Proto。
...
SECURE_HSTS_INCLUDE_SUBDOMAINS = os.getenv(
    'SECURE_HSTS_INCLUDE_SUBDOMAINS', str(not DEBUG),
).lower() == 'true'
